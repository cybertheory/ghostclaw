...
const STORAGE_KEY = "ghostclaw-promote-card-dismissed";
      ...
      <CardContent className="flex flex-col gap-4 p-4 py-0 md:flex-row md:items-center md:justify-between">
        <div className="space-y-2 md:max-w-[70%]">
          <CardTitle className="text-xs lg:text-sm">
            Promote GhostClaw, Earn Rewards
          </CardTitle>
          <CardDescription className="text-[10px] lg:text-xs">
            Share GhostClaw on social, hit 5K impressions, and we&apos;ll send you
            a $5&ndash;$10 coupon for a monthly plan. Open an issue or discussion at{" "}
            <a
